...
- hrscore = %hrscore/total_hrs -> Số điểm phải tăng mỗi giờ -> tính 1 lần khi tạo task
- total_hrs = deadline - begin -> tổng số giờ -> tính 1 lần khi tạo task

- hrsup = now-begin -> số giờ đã trôi qua -> tính mỗi lần gọi display trong hàm tính uscore
...
Giả sử trôi qua 1hr
T1: 
- hrsleft = 39 (tổng thời gian được cho để làm tsk = 40, đã trôi qua 1hr => còn lại 39hr để làm task)
- hrsup = 1 (đã trôi qua 1hr) → usc = 12 + 1*2.2 = 14.2
T2: usc = 60 + 1*1 = 61  
T3: usc = 60 + 1*2 = 62 

Task 3 có 20hr -> hiện tại trôi qua 19hr (gần hết giờ của task 3, task 1 và task 2 còn 21hr)
