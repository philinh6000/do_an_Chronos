...
#include <limits> // dùng numeric_limit + streamsize để lấy số lượng ký tự rác tối đa -> đảm bảo xóa sạch nếu user cố tình nhập chuỗi rất dài hàng ngàn chữ
...
bool Task::operator<(const Task& other) const{
    if (this->deadline == other.deadline) return this->priority_score > other.priority_score;
